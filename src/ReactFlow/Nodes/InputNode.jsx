    ...
    <Fragment>
      <div className="">
        <div className="bg-boxbg inline-block rounded-lg p-0.25">
          <div className="w-52 rounded-lg border-2 border-outerborder bg-gradientbg pb-2">
            <div className="flex justify-between bg-flowlabelbg rounded-t-lg px-3 py-1 border-b border-outerborder">

              <div className="text-sm text-white">Input Node</div>
              <div className="flex">
              <div className="text-8 w-fit text-white bg-frogbg py-1 px-2 rounded text-center shadow-frogshadow mx-1">
                FRAG
              </div>
